...
-- NOTE: Users are created via the Supabase Admin API (auth.admin.createUser),
-- NOT via direct SQL INSERT. Direct SQL inserts into auth.users produce
-- password hashes that the auth service cannot verify, causing 500 errors
-- on login. Users were created with password "Hevre222026" and
-- email_confirm: true. The admin user has app_metadata { is_admin: true }.
-- ============================================
